...
<!--                        <li><a href="cart.php">View all Orders</a></li>-->
                        ...
                        <li><a href="paymentinfo.php">All Payments</a></li>
                    </ul>
                </div>  
            </div>
        </div>
                                ...
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-remove">Customer Name</th>
                                            <th class="product-remove">Phone Name</th>
                                            <th class="product-remove">Phone Quantity</th>
                                            <th class="product-remove">Phone Total Price</th>
                                            <th class="product-remove">Address</th>
                                            <th class="product-remove">Phone Numbers</th>
...
<?php
              $pid = $_GET["id"];
              $sql ="SELECT * FROM paymentclass where payment_id = '$pid'";
            ...
            ?>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-name">
                                                <a href="ProductDetailDemo.php?id=<?=$row["shoe_id"]?>"</a>
                                                <span><?=$row["shoe_name"]?></span>
                                            </td>

                                            <td class="product-price">
                                                <span class="amount"><?=$row["shoe_quantity"]?></span> 
                                            </td>
                                            <td class="product-price">
