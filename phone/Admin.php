                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="single-shop-product">
                        ...
                        <div class="product-option-shop">                       
                               <a class="add_to_cart_button" href="updatePhoneForm.php?id=<?=$row["shoe_id"]?>">Update</a><a class="add_to_cart_button" href="ProductDetail.php?id=<?=$row["shoe_id"]?>&brand=<?=$row["shoes_brand"]?>&type=<?=$row["shoe_type"]?>&color=<?=$row["shoe_color"]?>">&nbsp;&nbsp;&nbsp;Detail&nbsp;</a>
                        </div>                       
                    </div>
                </div>
                <?php
...
?>
            ...
            if ($current_page > 1 && $total_page > 1){
                ...
                echo '<a href="Admin.php?page=<?=$previous_page?>" aria-label="Previous">
            ...
            if ($current_page < $total_page && $total_page > 1){
                ...
                echo '<a href="Admin.php?page=<?=$next_page?>" aria-label="Next">
